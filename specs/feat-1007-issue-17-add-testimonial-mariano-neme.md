...
- [ ] Add Spanish original keys `testimonials.6.*` to `src/i18n/es.ts`
- [ ] Add English translation keys `testimonials.6.*` to `src/i18n/en.ts`
- [ ] Add Chinese translation keys `testimonials.6.*` to `src/i18n/zh.ts`

**Phase 2: Component Registration**
- [ ] Append testimony 6 object to `testimonials[]` array in `src/components/Testimonials.astro` (after index 5 / Guiselle Fonsepi entry)
...
- [ ] Run build: `npm run build` → verify pages built successfully, no errors
...
- [ ] All 7 pages built (ES, EN, ZH + sub-pages)
...
8. [ ] Confirm existing slides 1 (Marcelo), 2 (Catalina), 3 (Ricardo), 4 (Guiselle) are unchanged

**Success Criteria:**
- [ ] Testimony 6 (Mariano Neme, Argentina) appears as 5th carousel slide
- [ ] Initials 'MN' displayed (no photo available)
- [ ] Text displayed in correct language per site language
- [ ] Existing 4 testimonials are unchanged
- [ ] No console errors
