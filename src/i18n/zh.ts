export const zh = {
  ...
  'testimonials.8.location': '哥伦比亚',
  'testimonials.8.text': 'Julián无疑是我在准备阿空加瓜登山时找到的最佳资源之一。他的YouTube频道是一份完整的指南——从装备到适应高原反应，一切都讲解得清晰真实。凭借他的建议，我做好了充分准备，最终成功登顶。他是那种真心希望别人实现梦想的人。衷心感谢Julián，下一座山峰再见！',
  'testimonials.9.name': 'Ana Paula Ferreira',
  'testimonials.9.location': '巴西',
  'testimonials.9.text': '我通过YouTube发现了Julián的工作，它对我的阿空加瓜准备至关重要。他以清晰易懂的方式解释每一个细节，从装备到高原适应策略。我在2026年1月的探险中运用了他的所有建议，最终成功登顶。非常感谢你，Julián！你真的太厉害了，希望有一天能和你一起攀登。',
